...
<body>
  ...
  <div class="container">
    ...
    <h2>Yleiskuvaus</h2>
    <p>Aurinkokunta on aurinkoa kiertävä planeettojen, kuiden ja muiden taivaankappaleiden muodostama kokonaisuus. Se sijaitsee Linnunradan spiraalihaaran Orionin käsivarressa.</p>

    <p>Aurinkokunnan keskus on Aurinko, jonka ympärillä kiertävät kahdeksan planeettaa. Planeetat jaetaan kiviplaneettoihin ja kaasujättiläisiin.</p>
